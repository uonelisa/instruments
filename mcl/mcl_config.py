...
class MCL_Config_Frequency_Ctrl:

    datatype = 2
    datakind = 34
    nt = namedtuple(
        'mcl_config_frequencyctrl',
...
class MCL_Config_GeneralPic_Ctrl:
    datatype = 2
    datakind = 45
    nt = namedtuple('MCL_config_GeneralPIC_ctrl',
                    'vcc_24v vcc_3p3v_ln vcc_5v_ln vcc_9v vcc_3p3v vcc_5v i_n v_n v_p i_p hw_rev')
    fmt = '>10dB'
